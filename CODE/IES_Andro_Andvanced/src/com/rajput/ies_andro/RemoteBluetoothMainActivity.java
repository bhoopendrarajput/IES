        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_DEVICE_NAME:
                ...
                Intent fileExploreIntent = new Intent(FileBrowserActivity.INTENT_ACTION_SELECT_FILE,
    					null, RemoteBluetoothMainActivity.this, FileBrowserActivity.class);
    			fileExploreIntent.putExtra(FileBrowserActivity.showCannotReadParameter,false);
    			startActivityForResult(fileExploreIntent, 6);
    			//processAndSendFile("/storage/emulated/0/customized-capability.xml");
                break;
            case MESSAGE_READ:
            	switch (msg.arg1) {
	                case 1:
