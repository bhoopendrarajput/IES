...
//	private static final BigInteger TWO = BigInteger.valueOf(2);
	...
	/** The modulus */
	protected static BigInteger modulus;

	/** the public exponent */
	protected static BigInteger publicExponent;
	 ...
	 * @return Cyphertext
	 */
	protected static BigInteger encrypt(BigInteger message) {
	 ...
	 * @return A message
	 */
	protected static BigInteger decrypt(BigInteger cyphertext) {
	 ...
	 */
	protected static BigInteger encode(String s) {
	 ...
	 */
	private static void encrypter() throws IOException {
