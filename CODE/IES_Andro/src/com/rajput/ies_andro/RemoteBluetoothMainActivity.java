...
public class RemoteBluetoothMainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        msgAdapter.add("My RSA Public ["+RSA.publicExponent.toByteArray().length+"]: " + byteArrayToString(RSA.publicExponent.toByteArray()));
        msgAdapter.add("My RSA Modulus["+RSA.modulus.toByteArray().length+"]: "+ byteArrayToString(RSA.modulus.toByteArray()));
    }
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_DEVICE_NAME:
                ...
                Intent fileExploreIntent = new Intent(
    					...
    					null,
    					RemoteBluetoothMainActivity.this,
...
try {
	...
	showText("Data Procceed:" + FileBrowserActivity.formatBytes(dataProceed)+" Time: "+(System.currentTimeMillis() - startTime ));
	fis.close();
	...
	public void onClickSend(View v){
		...
		mCommandService.writeObject(msg);
